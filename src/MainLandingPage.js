      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          <NavRow>
            ...
            <DownloadLink className="menu__top" target="_blank" href="https://www.upwork.com/freelancers/~0125395ff738e68024?viewMode=1">
            Contact US
            </DownloadLink>
          </NavRow>
          <HeroRow>
            <TextColumn>
              <Heading>Modern React Templates By Muhammad Hafeez.</Heading>
              <Description>
              Easily to create modern React UI Websites and Components built using Redux and TailwindCSS which are also lightweight and simple to setup. All components are modular and fully responsive for great mobile experience as well as big desktop screens. Contact us if you want to create Responsive Websites, Web Applications, or Landing Pages for your business.
              </Description>
              <FeatureList>
          ...
          <SectionContainer id="landingPageDemos">
            ...
            <SectionDescription>
            We have 7 premade landing pages. Click on the "View Live Demo" button to see them in action. 
            Contact us If you want to create a responsive Landing Page for your business.
            </SectionDescription>
            <PreviewCards>
          ...
          <SectionContainer>
            ...
            <SectionDescription>
            We also provide 8 additional inner pages for your various needs like a signup, login, pricing, about us, contact, blog etc. To view them in action click the "View Live Demo" button.
            </SectionDescription>
            <PreviewCards>
